...
class Canvas(QtWidgets.QWidget):
    ...
    def paintEvent(self, event):
        ...
        text_line_rect = QtCore.QRect(100, 30, 200, 18)
        ...
        grid = QtCore.QRect(50, 50, 300, 300)
        ...
        for y in range(self.matrix.grid):
            for x in range(self.matrix.grid):
                ...
                self.matrix.data[y][x][0].set_y(75 + (y + 1) * self.matrix.space_between_tiles + y * self.matrix.tile_size)
